...
<div id="wrapper">
	<div id="header">
		<div id="logo">
			...
			<h2><a href="#">Find your images</a></h2>
		</div>
		<!-- end div#logo -->
		<div id="menu">
			<ul>
...
Print "<table border=0 cellpadding='5' width='95%'>";
Print "<tr>";
Print "<td><b>Όνομα</b></td> <td><b>Τελευταία Σύνδεση</b></td><td><b>Πληροφορίες</b> </td> ";
Print "</tr>";
...
Print " <td>".$info['lastLog'] . " </td>";
Print " <td>".$info['userRemark'] . " </td></tr>";

}
Print "</table>"; 
}
if ($action=="addnew"){
$out.="<td align=\"right\">".$adminConfig['newUserMsgfirst']."</td>\n";
$out="<form action=\"\" method=\"POST\">\n";
$out.="<input type=\"hidden\" name=\"action\" value=\"\">\n";
$out.="<input type=\"submit\" id=\"button\" value=\"".$adminConfig['cancelBtn']."\">\n";
$out.="</form>\n";
